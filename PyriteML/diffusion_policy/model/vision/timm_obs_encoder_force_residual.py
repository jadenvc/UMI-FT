...
class TimmObsEncoderForceResidual(ModuleAttrMixin):
    def __init__(
        self,
        shape_meta: dict,
        fuse_mode: str,
        ...
        for key, attr in obs_shape_meta.items():
            ...
            if type == "rgb":
                ...
                if "wrench" in key:
                    ...
                    key_model_map[key] = nn.Linear(shape[-1], self.v_feature_dim)
            elif type == "timestamp":
    ...
    def forward(self, obs_dict):
        ...
        for key in self.rgb_keys:
            ...
            enc_dict[key] = feature.reshape(B, T, -1)
        ...
        for key in self.wrench_keys:
            ...
            enc_dict[key] = feature.unsqueeze(1)
    ...
    def output_shape(self):
        ...
        assert len(example_output["rgb_0"].shape) == 3
        assert example_output["rgb_0"].shape[-1] == 768

        return example_output["rgb_0"].shape


if __name__ == "__main__":
    timm_obs_encoder_with_force = TimmObsEncoderForceResidual(
        shape_meta=None,
