...
class TrainResidualTransformerWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.obs_encoder: TimmObsEncoderForceResidual = hydra.utils.instantiate(
            cfg.obs_encoder
        )
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                with tqdm.tqdm(
                    ...
                    for batch_idx, batch in enumerate(tepoch):
                        ...
                        nobs_sparse = sparse_normalizer.normalize(
                ...
                if (
                    ...
                    with torch.no_grad():
                        ...
                        nobs_sparse = dict_apply(nobs_sparse, lambda x: x.to(device))
                        sparse_nobs_encode, time_encode = self.obs_encoder(nobs_sparse)
                        pred_action = policy.predict_actions(
