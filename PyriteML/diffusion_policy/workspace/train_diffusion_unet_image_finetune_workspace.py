...
class TrainDiffusionUnetImageFinetuneWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        if cfg.training.resume:
            ...
            print(
                "No checkpoint found. Check 'output_dir' in your workspace config file"
            )
            exit(0)
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                with tqdm.tqdm(
                    ...
                    for batch_idx, batch in enumerate(tepoch):
                        ...
                        # unwrap model to access underlying module (needed for gradient logging)
                ...
                def log_action_mse(step_log, category, pred_action, gt_action):
                    ...
                    if pred_naction_sparse.shape[-1] > 9:
                        ...
                        step_log[f"{category}_sparse_vt_naction_mse_error"] = (
                            torch.nn.functional.mse_loss(
                                pred_naction_sparse[..., 9:18],
                                gt_naction_sparse[..., 9:18],
                            )
                        )
