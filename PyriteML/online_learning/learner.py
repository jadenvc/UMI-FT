...
class Learner:
    def __init__(
        ...
        self.network_weight_server.add_topic(
        ...
        self.transitions_client = rmq.RMQClient(
            client_name="transitions_client",
    ...
    def receive_transitions(self):
        ...
        retrieved_data, timestamp = self.transitions_client.pop_data(
            topic=self.transitions_topic, n=1
        )
