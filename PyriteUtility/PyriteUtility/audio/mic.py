...
from PyriteUtility.data_pipeline.shared_memory.shared_memory_queue import (
    Empty,
    SharedMemoryQueue,
)
        ...
        try:
            ...
            while not self.stop_event.is_set():
                ...
                try:
                    ...
                    t_cal = (
                        data["timestamp"] - self.receive_latency
                    )  # calibrated audio latency
                    ...
                    if self.put_downsample:
                        ...
                        step_idx = int(
                            (data["timestamp"] - put_start_time) * self.put_fps
                        )
                        put_data["step_idx"] = step_idx
                        put_data["timestamp"] = t_cal
                        self.ring_buffer.put(put_data, wait=False)
