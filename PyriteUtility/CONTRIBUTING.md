...
- Target Python: 3.8+
- Lint rules: pycodestyle (E, W), Pyflakes (F), isort (I); ignores `E501` and `E402` (module imports not at top, temporarily suppressed while layout is corrected)
