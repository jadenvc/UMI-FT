...
raw_umi_data_dir=$umift_data_parent_dir/data/umift_data 
session_name="test" # set the exact same session name as in your iPhone
time=30 # how long the CoinFT data collection lasts. CoinFT data collection should start earlier than the iPhone data collection, and end later.
...
MODELS="NFT5_MLP_5L_norm_L2.onnx NFT4_MLP_5L_norm_L2.onnx"   # CoinFT calibration model paths. they later become [model_0_path, model_1_path]
NORMS="NFT5_norm.json NFT4_norm.json" # CoinFT calibration normalization constants.
...
STATIC_PLOT="--static_plot" # static plot later displays the history of F/T data after data collection
