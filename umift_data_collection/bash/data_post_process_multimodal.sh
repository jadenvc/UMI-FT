...
raw_umi_data_dir=/store/real/hjchoi92/data/real/test # (USER TODO) change this to the directory where the raw umi gopro+iphone data are saved on your computer
session_name="WBW-iph-b0" # (USER TODO) change this to the session name of the raw umi gopro+iphone data
