...
if __name__ == "__main__":
    ...
    if task_to_perform == 'merge_zarr':
        input_zarrs = [
            "/store/real/hjchoi92/data/real/umift/WBW-iph-b0/processed_data/all/acp_replay_buffer_gripper.zarr",
            "/store/real/hjchoi92/data/real/umift/WBW-iph-b1/processed_data/all/acp_replay_buffer_gripper.zarr",
            "/store/real/hjchoi92/data/real/umift/WBW-iph-b2/processed_data/all/acp_replay_buffer_gripper.zarr",
            "/store/real/hjchoi92/data/real/umift/WBW-iph-b3/processed_data/all/acp_replay_buffer_gripper.zarr",
            "/store/real/hjchoi92/data/real/umift/WBW-iph-b5/processed_data/all/acp_replay_buffer_gripper.zarr"
        ]
        output_zarr = "/store/real/hjchoi92/data/real_processed/umift/WBW-iph/acp_replay_buffer_gripper.zarr"
        ...
        zarr_path = "/store/real/hjchoi92/data/real_processed/umift/WBW300/acp_replay_buffer_gripper.zarr"
        episodes_to_remove = [101]
