...
from umift.processing.wired_time_sync import fetch_campose_gripper_time_json, fetch_ft_time_cvs, trim_ft_wrt_campose, fetch_image_time, fetch_ultrawide_image_time, get_session_name
...
def process_ft_img_campose_gripper(args):
    ...
    # HC TODO: add ultrawide and depth
