...
dataset_path = "/store/real/hjchoi92/data/real/test/WBW-iph-b0/processed_data/all/acp_replay_buffer_gripper.zarr"
...
titles = ["RGB Image", "Ultrawide", "Pose", "Gripper", "Wrench", "Stiffness"]

print("Finished loading data")


# Initialize figure and axes
fig, axes = plt.subplots(6, 1, figsize=(10, 20), gridspec_kw={'height_ratios': [3, 3, 1, 1, 1, 1], 'hspace': 0.5})
ax_rgb, ax_uw, ax1, ax2, ax3, ax4 = axes
ax_rgb.axis("off")
ax_uw.axis("off")
...
def update_image(time):
    ...
    ax_uw.clear()
    uw_frame = ultrawide[map_to_uw_idx[closest_idx]]
    if uw_frame.ndim == 4:
        uw_frame = uw_frame.squeeze(0)
    ax_uw.imshow(uw_frame)
    # ax_uw.imshow(ultrawide[map_to_uw_idx[closest_idx]])  # Map to uw frame
